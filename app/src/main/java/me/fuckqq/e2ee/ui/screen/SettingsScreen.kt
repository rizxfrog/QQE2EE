...
import me.fuckqq.e2ee.ui.ClickableSettingItem
import me.fuckqq.e2ee.ui.ColorSettingItem
import me.fuckqq.e2ee.ui.RangeSliderSettingItem
import me.fuckqq.e2ee.ui.SettingsHeader
import me.fuckqq.e2ee.ui.SliderSettingItem
    ...
    LazyColumn(
        ...
        item {
            ClickableSettingItem(
                ...
                onClick = {
                    val intent = Intent(Intent.ACTION_VIEW, "https://github.com/WJZ-P/QQE2EE".toUri())
...
private fun handleCheckUpdate(context: Context, scope: CoroutineScope, versionName: String) {
    scope.launch {
        ...
        val latestRelease: GitHubRelease? = withContext(Dispatchers.IO) {
            try {
                val url = URL("https://api.github.com/repos/WJZ-P/QQE2EE/releases/latest")
                val connection = url.openConnection() as HttpURLConnection
                val jsonText = connection.inputStream.bufferedReader().use(BufferedReader::readText)
                Log.d(QQE2EEApp.TAG,jsonText)
