...
fun getFileSize(uri: Uri): Long {
    QQE2EEApp.instance.contentResolver.query(
        uri,
...
fun getFileName(uri: Uri): String {
    ...
    QQE2EEApp.instance.contentResolver.query(uri, null, null, null, null)?.use { cursor ->
...
fun getImageAspectRatio(uri: Uri): Float? {
    val currentService = QQE2EEApp.instance
    return try {
