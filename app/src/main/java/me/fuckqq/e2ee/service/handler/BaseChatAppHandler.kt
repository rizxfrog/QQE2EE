...
import me.fuckqq.e2ee.ui.component.DecryptionPopup
import me.fuckqq.e2ee.ui.dialog.AttachmentPreviewState
import me.fuckqq.e2ee.ui.dialog.AttachmentState
import me.fuckqq.e2ee.ui.dialog.SendAttachmentDialog
...
import me.fuckqq.e2ee.util.getFileSize
import me.fuckqq.e2ee.util.getImageAspectRatio
import me.fuckqq.e2ee.util.isEmpty
import me.fuckqq.e2ee.util.isFileImage
import me.fuckqq.e2ee.util.isNodeValid
import java.io.File
    ...
    private fun showDecryptionPopup(
        ...
        popupManager = NCWindowManager(
            ...
            CompositionLocalProvider(
                LocalFileActionHandler provides { fileInfo ->
                    FileActionHandler(service!!).show(
                        fileInfo
                    )
                }
            ) {
